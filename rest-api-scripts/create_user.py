...
'''
**********CREATE USERS******************
python create_user.py --fire_host_url="https://localhost:8080" --access_token="cacaksncaskjuuonn777-cdck" --users_file_path="new_users_file_path"
...
# add user
def add_user(fire_host, token, user_name, pwd, first_name, last_name, user_email,
...
if __name__ == '__main__':
    ...
    for line in f:
        ...
        if len(user_details) != 9:
            ...
            print(line)
            print(
                "Required information: <username>,<password>,<first_name>,<last_name>,<email>,<role_ids>,<group_ids>,<is_superuser>,<is_active>")
            ...
            add_user(fire_host=fire_host_url, token=access_token, user_name=username, pwd=password,
                               first_name=first_name, last_name=last_name, user_email=email,
                               user_roles=role_ids, user_groups=group_ids, is_superuser=is_superuser,
                               is_active=is_active)
