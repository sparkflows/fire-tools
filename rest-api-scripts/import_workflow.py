...
# import workflow
#**********COMMAND******************
#python import_workflow.py --fire_host_url="https://localhost:8080" --access_token="token123" --workflow_json_path="Workflow_123.json" --project_id="456" --uuid_option="createNewUUID"
#***********************************
...
if __name__ == '__main__':
    ...
    my_parser.add_argument('--workflow_json_path', help='Workflow json path is required', type=str, required=True)
    ...
    print("workflow_json_path: " + workflow_json_path)
    print("project_id: " + project_id)
    print("uuid_option: " + uuid_option)

    try:
        import_workflow(access_token, fire_host_url, workflow_json_path, project_id, uuid_option)
