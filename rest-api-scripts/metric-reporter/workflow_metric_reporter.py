...
def get_longest_latency(total_reporter_dataframe, project_id):
    workflow_dataframe = total_reporter_dataframe.groupby(["analysisFlowId", "workflow_name"])[
...
def get_status_count(total_reporter_dataframe, project_id):
    workflow_dataframe = total_reporter_dataframe.groupby(["analysisFlowId", "workflow_name", "status"])[
        "status"].count()
