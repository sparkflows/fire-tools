...
# import project
#**********COMMAND******************
#python import_project.py --fire_host_url="https://localhost:8080" --access_token="cacaksncaskjuuonn777-cdck" --project_zip_path="C:\Users\NMBR\Downloads\Projects_133535.zip" --project_id=42 --selected_project_name="pipeline-test"
#***********************************
